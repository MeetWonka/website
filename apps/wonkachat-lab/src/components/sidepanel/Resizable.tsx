...
/**
 * Ported verbatim from WonkaChat/packages/client/src/components/Resizable.tsx
 * — a thin, unstyled-by-default wrapper around `react-resizable-panels`.
 */
...
export const ResizableHandleAlt = ({
  withHandle,
  className = '',
  ...props
}: React.ComponentProps<typeof ResizablePrimitive.PanelResizeHandle> & {
